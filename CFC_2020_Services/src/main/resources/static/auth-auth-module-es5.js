...
var SignInComponent = /** @class */ (function () {
    function SignInComponent(_fb, ajax, _router, utilService, authGuard) {
        this._fb = _fb;
        this.ajax = ajax;
    ...
    SignInComponent.prototype.onSubmit = function () {
        ...
        this.ajax.sendRequest('LOGIN', payload).subscribe(function (data) {
            if (!!data) {
                _this.utilService.setUser(Object(lodash__WEBPACK_IMPORTED_MODULE_6__["get"])(data, 'response.details'));
                if (_this.authGuard.nextUrl) {
                    _this._router.navigateByUrl(_this.authGuard.nextUrl);
                    _this.authGuard.nextUrl = '';
                }
                else {
